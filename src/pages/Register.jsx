...
const Register = () => {
  ...
  const { loader, userInfo, errorMessage, successMessage, locale } =
          ...
          <div className="grid  grid-cols-2 md-lg:grid-cols-1 w-[60%] mx-auto bg-white rounded-xl">
            <div className="px-8 py-8">
              <h2 className="text-center w-full text-xl text-slate-600 font-bold">
                <FormattedMessage id="home-register.register" />
              </h2>

              <div>
                <form onSubmit={register} className="text-slate-600">
                  <div className="relative flex flex-col gap-1 mb-7 w-full">
                    <label
                      htmlFor="name"
                      className={` ${
                    ...
                    >
                      <FormattedMessage id="home-register.name" />*
                    </label>
                    <input
                      ...
                      id="name"
                      placeholder={
                        locale === "vi" ? "Nhập họ tên" : "Enter your name"
                      }
                    />
                    {errors.name && (
                      <span className="text-red-500 text-sm absolute left-4 top-[105%]">
                        {errors.name}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-1 mb-7 w-full relative">
                    ...
                    >
                      <FormattedMessage id="home-register.email" />*
                    </label>
                    <input
                      onChange={inputHandle}
                      value={state.email}
                  ...
                  <div className="flex flex-col gap-1 mb-7 w-full relative">
                    ...
                    >
                      <FormattedMessage id="home-register.password" />*
                    </label>
                    <input
                      onChange={inputHandle}
                ...
                <div className="flex justify-center items-center py-2">
                  ...
                  <span className="px-3 text-slate-600">
                    <FormattedMessage id="home-register.or" />
                  </span>
                  <div className="h-[1px] bg-slate-300 w-[95%]"> </div>
                </div>
                ...
                <button className="px-8 w-full py-2 bg-blue-600 shadow hover:bg-blue-500 duration-200 rounded-xl flex justify-center items-center gap-2 mb-3">
                  ...
                  <span className="text-white">
                    <FormattedMessage id="home-register.login_with_facebook" />
                  </span>
                </button>
                <button className="px-8 w-full py-2 bg-orange-600 shadow hover:bg-orange-500 duration-200  rounded-xl flex justify-center items-center gap-2 mb-3">
                  ...
                  <span className="text-white">
                    <FormattedMessage id="home-register.login_with_google" />
                  </span>
                </button>
              </div>
              <div className="text-center text-slate-600 pt-1 ">
                <p>
                  <FormattedMessage id="home-register.have_account" />
                  <Link
                    className="text-blue-500 hover:bg-blue-200 rounded-xl ml-3 text-center px-2 py-1 duration-200 "
                    to="/login"
                  >
                    <FormattedMessage id="home-register.login" />
                  </Link>
                </p>
              </div>
