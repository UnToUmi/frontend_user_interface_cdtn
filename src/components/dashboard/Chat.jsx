      ...
      <div className="w-full flex">
        ...
        >
          ...
          {my_friends.length > 0 ? (
            <div className="w-full flex flex-col text-slate-600 py-4 h-[400px] pr-3">
              {my_friends.map((f, i) => (
                <Link
                  ...
                  key={i}
                  className={`flex gap-2 justify-start items-center pl-2 py-[8px] px-2 hover:bg-green-400 duration-200 rounded-xl`}
                >
            ...
            <div className="w-full bg-green-500 py-3 rounded-xl translate-y-[20%]  flex items-center justify-center text-xl">
              {`No seller :((`}
            </div>
          )}
        </div>
            ...
            <div className="w-full h-full">
              <div className="flex justify-between gap-3 items-center text-slate-600 text-xl h-[50px]">
                ...
                <div
                  ...
                  className="w-[35px] h-[35px] hidden md-lg:flex cursor-pointer rounded-sm justify-center items-center bg-green-500 text-white"
                >
                  <FaList />
                </div>
              </div>
              <div className="h-[400px] w-full bg-slate-100 p-5 rounded-xl ">
                      ...
                      return (
                        ...
                        >
                          <img
                            ...
                            alt=""
                          />
                          <div className="px-3 py-2 bg-slate-600 text-white rounded-xl">
                            <span>{m.message}</span>
                          </div>
                        </div>
                      );
                      ...
                      return (
                        ...
                        >
                          <img
                            ...
                            alt=""
                          />
                          <div className="px-3 py-2  bg-blue-600 text-white rounded-xl">
                            <span>{m.message}</span>
                          </div>
                        </div>
                      );
              ...
              <div className="flex p-2 justify-between items-center w-full">
                <div className="w-[40px] cursor-pointer hover:bg-purple-500 hover:text-white duration-200 h-[40px] border p-2 justify-center items-center flex rounded-full">
                ...
                <div className="border h-[40px] p-0 ml-2 w-[calc(100%-90px)] rounded-full relative">
                  <input
                    ...
                    className="w-full rounded-full h-full outline-none py-3 px-4"
                  />
